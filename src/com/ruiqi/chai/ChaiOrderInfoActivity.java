...
import com.ruiqi.works.ModifiyOrderActivity;
import com.ruiqi.works.R;

public class ChaiOrderInfoActivity extends BaseActivity implements ParserData {
	...
	private TextView tv_username, tv_usermobile, tv_useraddress,
			...
			tv_yunfei_content, tv_total_content,tv_yunfei;
			...
			for (int i = 0; i < GrassOrder.mData.size(); i++) {
				...
				if (o.getOrdersn().equals(ordersn)) {
					...
					for (int j = 0; j < mList.size(); j++) {
						...
						SPutilsKey.list.add(new Type(od.getGoods_price(), od.getTitle(), od.getNum(), od.getGoods_id(),od.getNorm_id(),od.getGoods_type(), od.getGoods_kind(), od.getTitle(), "0",od.getNum()));
					}
	...
	public void onClick(View v) {
		...
		case R.id.tv_select:// 修改订单
			intent = new Intent(ChaiOrderInfoActivity.this,ModifiyOrderActivity.class);
		...
		case R.id.tv_start:// 开始订单
			String from = (String) SPUtils.get(ChaiOrderInfoActivity.this,"createorder", "error");
			SPUtils.put(this, "createorder", "");
			SPutilsKey.type = 2;
			if (from.equals("CreateOrderActivity")) {
				SPUtils.remove(ChaiOrderInfoActivity.this, "createorder");
			}
			SPUtils.put(ChaiOrderInfoActivity.this, "ordersn", ordersn);
			SPUtils.put(ChaiOrderInfoActivity.this, "username", tv_username.getText().toString().trim());
			SPUtils.put(ChaiOrderInfoActivity.this, "usermobile", tv_usermobile.getText().toString().trim());
			SPUtils.put(ChaiOrderInfoActivity.this, "useraddress", tv_useraddress.getText().toString().trim());
			SPUtils.put(ChaiOrderInfoActivity.this, "type", list);
			SPUtils.put(ChaiOrderInfoActivity.this, "money", tv_total_content.getText().toString().trim());
			Log.e("lll", "订单金额应付"+tv_total_content.getText().toString().trim());
			SPUtils.put(ChaiOrderInfoActivity.this, "yunfei", tv_yunfei_content.getText().toString().trim());
			SPUtils.put(ChaiOrderInfoActivity.this, "total", tv_total_content.getText().toString().trim());
			SPUtils.put(ChaiOrderInfoActivity.this, "kid", kid);
			intent = new Intent(ChaiOrderInfoActivity.this, ChaiWeightActivity.class);
