...
public class ChaiListViewAdapterText3 extends BaseAdapter {

	private ViewHolder holder;
	private List<ChaiTableInfo> list;
	private Context context;

	public ChaiListViewAdapterText3(Context context, List<ChaiTableInfo> list) {
		this.list = list;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context).inflate(R.layout.chai_listview_item_text3, null);
